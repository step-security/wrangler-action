...
declare function parseWranglerVersion(stdout: string): string;
declare function isExactSemver(version: string): boolean;
declare function installWrangler(config: WranglerActionConfig, packageManager: PackageManager): Promise<string>;
...
export { authenticationSetup, execCommands, info, installWrangler, isExactSemver, main, parseWranglerVersion, uploadSecrets, wranglerCommands, };
